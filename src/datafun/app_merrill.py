...
DATA_FILE_PATH: Final[Path] = Path("data") / "penguins_merrill.csv"
...
The sex column has a small number of unique values.
There are two unique sexes, so a for loop can
